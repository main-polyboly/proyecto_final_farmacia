...
5. DEMOSTRACIÓN EN VIVO Y EVIDENCIA
---------------------------------------------------------
Ejecutar desde PowerShell en D:/farmacia_salud:

    & ./venv/Scripts/python.exe ./farmacia_salud/main.py

En el PASO 2, el programa registra una venta de 5 unidades y muestra:
- Estado inicial: caja ERP, stock SCM y órdenes de compra.
- Evento ERP: asiento contable y aumento de caja.
- Evento SCM: descuento de stock y posible orden de compra.
- Evento Dashboard: regeneración de gráficos y total acumulado de ventas.
- Resumen CAMBIOS DETECTADOS con valores antes y después.

Archivos visuales para mostrar lado a lado:
- outputs/dashboard_antes.png: estado antes de la venta.
- outputs/dashboard_despues.png: estado después de la venta.
- outputs/dashboard_completo.png: estado final combinado.

La diferencia principal se observa en el gráfico KPI ERP/SCM: aumenta la barra
de caja por el importe de la venta y disminuye el stock del producto vendido.
El gráfico RFM puede permanecer igual porque una sola venta no necesariamente
cambia los segmentos de clientes. Si el stock queda bajo el mínimo, también
aparece una orden de compra SCM.

Comparación de referencia de la demo:
- Ventas: 6020 -> 6021.
- Caja sucursal 1: $0.00 -> $34.20.
- Stock del producto demo: 90 -> 85 unidades.
- Órdenes de compra: 0 -> 0, porque el stock continúa sobre el mínimo.
